...
<%
    //获得要修改的地址的ID
    String id= (String) session.getAttribute("modify_address_id");
%>

<!--待开发-->
<div style="height: 100px;background-color: darkcyan">
    <br>
    <div align="center"><b style="font-size: 25px;color: white">修改地址</b></div>
</div>
...
<div>
    ...
    <div style="height:800px; width: 80%;border: 1px solid green;float:left;box-sizing: border-box">
        <b>送货地址：</b><br><br>
        <form action="/j2eeAssignment/self_info/modify_address" method="get">
        <table class="table" id="project">
            <th>编号ID</th><th>描述</th><th>城市</th><th>区县</th><th>镇/街道</th><th>路</th>
            <tr>
                <td><%=id%></td>
                <td><input name="new_address"></td>
                <td><input name="new_city"></td>
                <td><input name="new_district"></td>
                <td><input name="new_town"></td>
                <td><input name="new_street"></td>
            </tr>
        </table>
        <b>PS：若为空则原地址对应内容不修改！</b><br>
        <button type="submit" name="func" value="abandon">不再使用此地址</button>
        <button type="submit" name="func" value="change">确认修改</button>
        </form>
    </div>
</div>
