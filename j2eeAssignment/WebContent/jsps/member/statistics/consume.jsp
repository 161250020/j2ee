...
<%
    //获取日期
    String date1= (String) session.getAttribute("consume_start_time");
    String date2= (String) session.getAttribute("consume_end_time");
    //获取金额
    double mon1= (double) session.getAttribute("consume_start_mon");
    double mon2= (double) session.getAttribute("consume_end_mon");
    //获取需要显示的订单的信息
    ArrayList<Member_order_info> mios= (ArrayList<Member_order_info>) session.getAttribute("consume_orders_list");
%>
<!--待开发-->
<div style="height: 100px;background-color: darkcyan">
    <br>
    <div align="center"><b style="font-size: 25px;color: white">消费</b></div>
</div>
...
<div>
    ...
    <div style="min-height:800px; width: 80%;border: 1px solid green;float:left;box-sizing: border-box">
        <form action="/j2eeAssignment/member/statistic_consume" method="get">
