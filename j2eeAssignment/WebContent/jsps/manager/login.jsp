...
<form method="get" action="/j2eeAssignment/manager/login">
    <input type="text" placeholder="用户名" name="in_username">
    ...
    <div align="center">
        <button onclick="encrypt()" type="submit" class="button success" style="margin: 0 auto">登录</button>
    </div>
</form>
</div>
<script>
