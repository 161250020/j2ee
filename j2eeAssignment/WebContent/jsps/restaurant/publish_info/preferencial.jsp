...
<div style="height: 100px;background-color: darkcyan">
    <br>
    <div align="center"><b style="font-size: 25px;color: white">发布优惠商品信息</b></div>
</div>
...
<div>
    ...
    <!--商家-->
    <form action="/j2eeAssignment/restaurant/new_preferencial" method="get">
    <div style="min-height:800px; width: 80%;border: 1px solid green;float:left;box-sizing: border-box">
        ...
        <div class="two">
            <input style="width: 50%" name="new_raw_price">
        </div>
