...
<form method="get" action="/j2eeAssignment/restaurant/login">
    <input type="text" placeholder="邮箱/7位编码" name="in_username">
    <input id="in_pass" type="password" placeholder="密码" name="in_pass">
	<div style="background-color: orange;width: 100%;height: 25px"><%=err_info %></div>

    <div class="one"><input type="submit" name="function" value="查看餐厅注册审批结果" style="border: 0px"></div>
    <div class="two" align="center"><input type="submit" name="function" value="注册" style="border: 0px"></div>

    <div align="center">
        <button onclick="encrypt()" type="submit" name="function" value="login" class="button success" style="margin: 0 auto">登录</button>
    </div>
</form>
</div>
<script>
