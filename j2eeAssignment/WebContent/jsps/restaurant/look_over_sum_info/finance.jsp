...
<%
    //获得订单的信息
    ArrayList<Member_order_info> orders= (ArrayList<Member_order_info>) session.getAttribute("finance_rest_orders_list");
    String start_time= (String) session.getAttribute("finance_rest_start_time");
    String end_time= (String) session.getAttribute("finance_rest_end_time");
    double start_mon= (double) session.getAttribute("finance_rest_start_mon");
    double end_mon= (double) session.getAttribute("finance_rest_end_mon");
...
<div style="height: 100px;background-color: darkcyan">
    <br>
    <div align="center"><b style="font-size: 25px;color: white">查看财务统计信息</b></div>
</div>
...
<div>
    ...
    <!--商家-->
    <form action="/j2eeAssignment/restaurant/finance_get_orders" method="get">
