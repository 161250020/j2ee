...
<%
    //获得订单的信息
    ArrayList<Member_order_info> orders= (ArrayList<Member_order_info>) session.getAttribute("order_rest_orders_list");
    String order_rest_start_time= (String) session.getAttribute("order_rest_start_time");
    String order_rest_end_time= (String) session.getAttribute("order_rest_end_time");
    double order_rest_start_mon= (double) session.getAttribute("order_rest_start_mon");
    double order_rest_end_mon= (double) session.getAttribute("order_rest_end_mon");
...
<div style="height: 100px;background-color: darkcyan">
    <br>
    <div align="center"><b style="font-size: 25px;color: white">查看点餐统计信息</b></div>
</div>
...
<div>
    ...
    <!--商家-->
    <form action="/j2eeAssignment/restaurant/order_get_orders" method="get">
        <div style="min-height:800px; width: 80%;border: 1px solid green;float:left;box-sizing: border-box">
            ...
            <div style="width: 34%;float: left;box-sizing: border-box">
                <input type="date" style="width: 90%" value=<%=order_rest_start_time%> name="start_date"/>
            </div>
            <div style="width: 33%;float: left;box-sizing: border-box">
                <input type="date" style="width: 90%" value=<%=order_rest_end_time%> name="end_date"/>
            </div>
            ...
            <div style="width: 34%;float: left;box-sizing: border-box">
                <input style="width: 90%" value=<%=order_rest_start_mon%> name="start_money">
            </div>
            <div style="width: 33%;float: left;box-sizing: border-box">
                <input style="width: 90%" value=<%=order_rest_end_mon%> name="end_money">
            </div>
